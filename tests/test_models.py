...
class TestModels(pyquoks.test.TestCase):
    ...
    def test_container(self) -> None:
        ...
        self.assert_type(
            ...
            message="object in the Container",
        )
    ...
    def test_values(self) -> None:
        ...
        self.assert_equal(
            ...
            message="edited data in the Values",
        )
